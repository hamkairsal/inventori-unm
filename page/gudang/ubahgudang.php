              ...
              <div class="table-responsive">
						...
						<label for="">Jenis Barang</label>
							...
							<?php
								...
								$sql = $koneksi->query("update gudang set kode_barang='$kode_barang', nama_barang='$nama_barang', jenis_barang='$jenis_barang', satuan='$satuan', foto='$foto' where kode_barang='$kode_barang'"); 
