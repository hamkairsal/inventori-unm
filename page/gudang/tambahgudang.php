              ...
              <div class="table-responsive">
						...
						<label for="">Jenis Barang</label>
							...
							if (isset($_POST['simpan'])) {
								...
								$sql = $koneksi->query("insert into gudang (kode_barang, nama_barang, jenis_barang, jumlah, satuan, foto) values('$kode_barang','$nama_barang','$jenis_barang','$jumlah','$satuan','$foto')");
