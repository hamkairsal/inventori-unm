...
<br>
       ...
       <!-- Begin Page Content -->
        <div class="container-fluid">
		  ...
		  <h3>Selamat Datang di Sistem Informasi Inventaris Barang Universitas Negeri Makassar</h3>
		  <br></br>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                     <a  href="?page=profilrektor"> <div class="text-xs font-weight-bold text-warning text-uppercase mb-1"><h4>Profil Rektor</h4></div>
