...
<head>
	...
	<style>
		body {
	          background: url(img/orange.jpg) no-repeat fixed;
...
<img src="img/logounm.png" alt="" width="100px">

				<form role="form" action="" method="post">
				<h3> Sistem Inventaris Barang UNM</h3>
				<br>
	...
	<?php
					...
					if ($login) {
						...
						if ($ketemu >=1) {
							...
							else if ($data['level'] == 'rektor' && $level == 'rektor') {
								$_SESSION['rektor'] =$data['id'];
