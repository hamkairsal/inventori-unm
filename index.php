...
<head>
  ...
  <title>Sistem Inventaris Barang UNM</title>
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-warning sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index3.php">
        <div class="sidebar-brand-text mx-2"><img src="img/logounm.png" alt="" width="50px"><b>UNM</b></div>
      </a>
 ...
 <?php
  ...
  <!--sidebar start-->
    ...
    <li class="d-flex align-items-center justify-content-center">
        <a class="nav-link">
		 <img src="img/<?php echo $data['foto']?>" class="img-circle" width="50" alt="User"/></a>
		  <li class="d-flex align-items-center justify-content-center">
		  </li>
	  </li>
		 <li class="nav-item ">
      ...
      <li class="nav-item active">
        ...
        <div id="collapseLaporan" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="?page=laporan_barangmasuk">Laporan Barang Tahunan</a>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
		 ...
		 <section class="content">
          ...
          if ($page == "profilrektor") {
            if ($aksi == "") {
              include "page/profilrektor/profilrektor.php";
            }
          }
